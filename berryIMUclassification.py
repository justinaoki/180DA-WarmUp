...
#Add old values for classification of X and Y
oldCFangleX = 0.0
oldCFangleY = 0.0
...
while True:
    ...
    #Classification of two motions: upward motion and downward motion
    #Calculate difference between old and new angles for X and Y 
    if(CFangleX - oldCFangleX < -1) and (CFangleY - oldCFangleY > 1):
        outputString += "\n Classification: Upward Motion. \n"
    elif (CFangleX - oldCFangleX > 1) and (CFangleY - oldCFangleY < -1):
        outputString += "\n Classification: Downward Motion. \n"

    #update old values
    oldCFangleX = CFangleX
    oldCFangleY = CFangleY
